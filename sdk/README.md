# MovieLens SDK - `movielensapi__sdk`
...
- API Render : [https://movies-backend-nnvw.onrender.com/](https://movies-backend-nnvw.onrender.com/)
- PyPI : [https://pypi.org/project/movielensapi-sdk](https://pypi.org/project/movielensapi-sdk)
